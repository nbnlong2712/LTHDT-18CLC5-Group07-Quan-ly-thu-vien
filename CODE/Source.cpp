...
int main()
{
	...
	while (luachon == 1)
	{
		...
		if (page == 0)
		{
			...
			cout << "3. XOA THU VIEN" << endl;
			cout << "4. Thoat" << endl;
			cout << "=====================" << endl;
			cout << "-> Moi chon chuc nang: ";          
			getline(cin, luachon0);
			if (luachon0 != "1" && luachon0 != "2" && luachon0 != "3"&&luachon0 != "4")
				continue;
			if (luachon0 == "1")
				page = 1;
			else if (luachon0 == "2")
		...
		if (page == 2)                                                                          
		{
			...
			if (L->setLib().size() == 0)
			{
				cout << " (Khong co thu vien)" << endl << endl;
				cout << "====================" << endl << endl;
				cout << "1. Trang truoc" << endl;
				cout << "2. Thoat" << endl;
				cout << "====================" << endl;
		...
		// PAGE 30                       // trang này để XÓA THƯ VIỆN
		if (page == 30)
		{
			system("cls");
			cout << endl << "          XOA THU VIEN " << endl << endl;
			string luachon30;
			if (L->setLib().size() == 0)
			{
				cout << " (Khong co thu vien)" << endl << endl;
				...
				cout << "====================" << endl;
				cout << "-> Moi nhap lua chon: ";
				getline(cin, luachon30);
				while (luachon30 != "1"&&luachon30 != "2")
				{
					cout << "   - Nhap lai lua chon: ";
					getline(cin, luachon30);
				}
			...
			{
				string k30;
				cout << "-> Nhap ten thu vien can xoa: ";
				getline(cin, k30);
				int linh30 = 0;
				while (linh30 == 0)
				{
					for (int i = 0; i < L->setLib().size(); i++)
					{
						if (chuan_hoa_main(k30) == chuan_hoa_main(L->setLib()[i]->setName()))
						{
							linh30 = 1;
							L->deleteLibrary(L->setLib()[i]);
						}
					}
					if (linh30 == 0)
					{
						cout << "   - Ten thu vien khong co! Nhap lai: ";
						getline(cin, k30);
					}
				}
				cout << endl << " Xoa thanh cong!" << endl;
				cout << endl << "========================" << endl;
				cout << "1. Tiep tuc xoa thu vien" << endl;
				cout << "2. Trang truoc" << endl;
				cout << "3. Thoat" << endl;
				cout << "========================" << endl;
				cout << "-> Moi nhap lua chon: ";
				getline(cin, luachon30);
				while (luachon30 != "1"&&luachon30 != "2"&&luachon30 != "3")
				{
					cout << "   - Nhap lai lua chon: ";
					getline(cin, luachon30);
				}
